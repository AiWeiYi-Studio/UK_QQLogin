...
<li class="<?php echo checkIfActive('ulist,user,info')?>">
...
<li class="<?php echo checkIfActive('urllist,addurl')?>">
	<a href="javascript:void(0)" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-cloud sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">分发管理</span></a>
	<ul>
<li>
...
<li>
	<a class="<?php echo checkIfActive("addurl") ?>" href="./addurl.php">
		添加分发
	</a>
</li>
	</ul>
</li>
<li class="<?php echo checkIfActive('logs,log,set,edkm,site,apiset,module,muban,gg,logo,clean,update')?>">
...
<li>
	<a class="<?php echo checkIfActive("logs") ?>" href="./logs.php">
		站长操作记录
	</a>
</li>
<li>
	<a class="<?php echo checkIfActive("edkm") ?>" href="./km.php">
		额度卡密生成
	</a>
</li>
<li>
	<a class="<?php echo checkIfActive("apiset") ?>" href="./set.php?mod=site">
		系统信息配置
	</a>
</li>
<li>
...
<li class="<?php echo checkIfActive('ukyun')?>">
	...
	<ul>
<li>
	<a class="<?php echo checkIfActive("ukyun") ?>" href="https://bbs.ukyun.cn/page/52.html">
		论坛反馈
	</a>
</li>
<li>
...
<li>
	<a class="<?php echo checkIfActive("ukyun") ?>" href="https://jq.qq.com/?_wv=1027&k=5ZwJVH0">
		官方Q群
	</a>
</li>
	</ul>
